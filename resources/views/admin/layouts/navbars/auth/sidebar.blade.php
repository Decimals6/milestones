<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl bg-white my-3 fixed-start ms-3 bg-blur shadow"
    id="sidenav-main">
    ...
    <div class="sidenav-header">
        ...
        <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
            ...
            <span class="ms-3 font-weight-bold">AJOFOOD Dashboard</span>
        </a>
    </div>
    <hr class="horizontal dark mt-0">
    <div class="collapse navbar-collapse w-auto flex-grow-1" id="sidenav-collapse-main" style="overflow-y: auto; height: calc(100vh - 150px);">
        <ul class="navbar-nav">
            <li class="nav-item">
            ...
            <li class="nav-item mt-3">
                <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Menu Management</h6>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Request::is('foods') ? 'active' : '' }}" href="{{ url('foods') }}">
                    <div
                        class="icon icon-shape icon-sm bg-white shadow text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fas fa-hamburger text-dark"></i>
                    </div>
                    <span class="nav-link-text ms-1">Foods</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Request::is('category-items') ? 'active' : '' }}"
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::is('foods-items') ? 'active' : '' }}"
                    href="{{ url('foods-items') }}">
                    <div
                        class="icon icon-shape icon-sm bg-white shadow text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fas fa-plus-square text-dark"></i>
                    </div>
                    <span class="nav-link-text ms-1">Food Options</span>
                </a>
            </li>
