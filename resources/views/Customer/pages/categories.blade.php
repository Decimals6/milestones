...
@php
    ...
    $filtered = $category === 'All Categories'
        ? $allProducts
...
<div class="container py-4 mb-5">
    <div class="d-md-none d-flex justify-content-between align-items-center mb-3">
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end shadow-sm">
                @foreach ($categories as $cat)
                    <li>
                        <a class="dropdown-item" href="{{ route('categories', ['name' => $cat]) }}">
                            {{ $cat }}
                        </a>
                    </li>
                @endforeach
        ...
        <a href="{{ route('categories') }}" class="btn btn-outline-secondary btn-sm rounded-pill px-3">
            Reset
        </a>
    </div>
    ...
    <div class="row g-3">
        @forelse($filtered as $product)
            <div class="col-6 col-md-4 col-lg-3">
                <x-product-card :title="$product['name']" />
            </div>
        @empty
            <div class="col-12">
